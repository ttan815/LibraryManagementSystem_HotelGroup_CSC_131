 ...
 * Author: Tony Tan & Michael Saldana
    ...
    <>
      ...
      <div id="searchContent">
        {bookLibrary && bookLibrary.map(book => //
          book.title.toLowerCase().includes(query.toLowerCase()) || book.author.toLowerCase().includes(query.toLowerCase()) || book.isbn.toLowerCase().includes(query.toLowerCase()) ? ( // .map goes through the array of JSON objects and filters the books shown to display only books that contain data stated in query
