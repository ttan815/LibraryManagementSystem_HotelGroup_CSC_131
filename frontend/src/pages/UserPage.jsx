    ...
    <BasePage className="user-page">
      ...
      <div className="user-header">
        ...
        <div className="user-actions">
          <button className="btn btn-outline refreshButton" onClick={refreshData} disabled={loading.loans || loading.reservations}>
        ...
        {activeTab === 'wishlist' && (
          <div className="wishlist-section">
            <div className="section-header">
              <h3>My Wishlist</h3>
              <button onClick={refreshData} className="btn btn-small btn-outline refreshButton" disabled={loading.wishlist}>
